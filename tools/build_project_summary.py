...
def main():
    ...
    para(doc,
         ...
         "23 feature extractors — about half interpretable classical-ML / signal-processing "
         ...
         "EmoNet visual-emotion schemas, and a Qwen2.5 vision–language model). The features are "
